  ...
  return (
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden [padding:calc(6rem+4rem)_var(--portfolio-page-padding)_6rem]">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute top-24 left-[clamp(10rem,18vw,24rem)] hidden size-[clamp(1.5rem,2.5vw,2.5rem)] rotate-45 bg-brand-primary opacity-60 sm:block"
      />
